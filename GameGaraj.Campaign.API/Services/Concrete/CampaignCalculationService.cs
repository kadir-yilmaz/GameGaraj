    ...
    public class CampaignCalculationService : ICampaignCalculationService
    {
        ...
        public async Task<CalculateDiscountResponse> CalculateAsync(CalculateDiscountRequest request)
        {
            ...
            if (!string.IsNullOrWhiteSpace(request.CouponCode))
            {
                ...
                else if (coupon.MinOrderAmount.HasValue && originalTotal < coupon.MinOrderAmount.Value)
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var couponDiscount = CalculateCouponDiscount(coupon, finalResponse.FinalTotal);
